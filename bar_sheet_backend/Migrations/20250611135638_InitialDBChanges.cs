        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DailyReports_Shops_ShopId",
                        column: x => x.ShopId,
                        principalTable: "Shops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductSizes_Shops_ShopId",
                        column: x => x.ShopId,
                        principalTable: "Shops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OB_Q = table.Column<int>(type: "int", nullable: false),
                    OB_P = table.Column<int>(type: "int", nullable: false),
                    OB_N = table.Column<int>(type: "int", nullable: false),
                    CB_Q = table.Column<int>(type: "int", nullable: false),
                    CB_P = table.Column<int>(type: "int", nullable: false),
                    CB_N = table.Column<int>(type: "int", nullable: false),
                    RC_Q = table.Column<int>(type: "int", nullable: false),
                    RC_P = table.Column<int>(type: "int", nullable: false),
                    RC_N = table.Column<int>(type: "int", nullable: false),
                    SP_Q = table.Column<int>(type: "int", nullable: false),
                    SP_P = table.Column<int>(type: "int", nullable: false),
                    SP_N = table.Column<int>(type: "int", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SaleProducts_DailyReports_DailyReportId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SaleProducts_Shops_ShopId",
                        column: x => x.ShopId,
                        principalTable: "Shops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleProducts_DailyReportId",
                table: "SaleProducts",
